...
const AdminServiceManagement = () => {
    ...
    const getEmployee = (idOrObj) => {
        ...
        return employees.find(e => (e.id || e._id) === id)
    }
    ...
    return (
        <DashboardLayout title="Task Allocation Hub">
            {/* Header */}
            <Box sx={{
            ...
            <Box px={3} pt={3}>
                ...
                <Grid container spacing={3} mb={4}>
                    {[
                        { label: 'Total Tasks', value: stats.total, color: '#9c27b0' },
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {loading ? (
                                ...
                                <TableRow><TableCell colSpan={7} align="center" sx={{ py: 10 }}>No tasks found</TableCell></TableRow>
                                            ...
                                            <Box display="flex" alignItems="center" gap={1.5}>
                                                ...
                                                <Box>
                                                    <Typography variant="body2" sx={{ fontWeight: 500 }}>
                                                        {operator?.name || (typeof service.assignedTo === 'object' ? service.assignedTo?.name : 'Unassigned')}
                                                    </Typography>
                                                    {operator && (
            ...
            <Dialog open={assignDialogOpen} onClose={() => setAssignDialogOpen(false)} maxWidth="xs" fullWidth>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleAssignConfirm} variant="contained" sx={{ bgcolor: colors.primary.main, '&:hover': { bgcolor: colors.primary.dark } }}>
                        Confirm Assignment
                    </Button>
                </DialogActions>
            </Dialog>
